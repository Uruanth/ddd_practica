...
public class CambiarQAResponsableComando extends Command {
    ...
    public CambiarQAResponsableComando(QAId qaId, QAResponsableId id, NombreQA nombreQA, ResultadosPrueba resultadosPrueba, ProductoFinal productoFinal) {
        this.qaId = qaId;
        this.id = id;
